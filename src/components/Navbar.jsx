...
export default function ProductDetails() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-12">
      {/* -- Product Details -- */}
      {/* 🟢 FIXED: gap-12 ko gap-8 md:gap-12 kar diya taaki mobile par spacing kam ho */}
      <div className="flex flex-col md:flex-row gap-8 md:gap-12 mb-12">
        ...
        <div className="flex-1 relative group">
          ...
          <div className="cursor-pointer relative overflow-hidden rounded-xl shadow-lg bg-gray-100 aspect-square" onClick={() => setIsLightboxOpen(true)}>
            {/* 🟢 FIXED: h-[500px] ko h-[300px] md:h-[500px] kar diya taaki mobile par image chhoti dikhe */}
            <img 
