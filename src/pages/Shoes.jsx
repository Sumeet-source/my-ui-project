...
export default function Shoes() {
  ...
  const applyFilters = (filters) => { const mergedFilters = { ...currentFilters, ...filters }; setCurrentFilters(mergedFilters); setFilteredProducts([]); setHasMore(true); fetchShoesProducts(1, true, mergedFilters); };
  const clearFilters = () => { const urlFilter = subCategoryFromUrl ? { subCategory: subCategoryFromUrl } : {}; setCurrentFilters(urlFilter); setFilteredProducts([]); setHasMore(true); fetchShoesProducts(1, true, urlFilter); };
