...
export default function Women() {
  ...
  const handleLoadMore = () => {
    setLoadingMore(true);
    fetchWomenProducts(currentPage + 1);
  };
  ...
  return (
    <div className="px-0 md:px-8 bg-white min-h-screen pb-10">
      ...
      {/* Sticky Filter Bar (Full width, no negative margins now) */}
      ...
      {loading ? (
        ...
        <div className="mt-6">
          {/* Perfect Grid Gap and Full Space */}
            ...
            {filteredProducts.length === 0 ? (
              ...
              filteredProducts.map((product) => (
                ...
                >
                  ...
                  {/* Image Container - Perfect Square (Removed rounded-xl) */}
                  ...
                  {/* Product Details - Adjusted padding for zero outer margin */}
